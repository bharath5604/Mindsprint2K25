...
//   // --- MODIFICATION START ---
//   // Add a new state to track the submission status
...
//         // --- MODIFICATION START ---
//         // Ensure isSubmitting is reset on validation failure
...
//         if (formData.member1Gender !== 'Female' || (formData.member2 && formData.member2Gender !== 'Female') || (formData.member3 && formData.member3Gender !== 'Female')) {
//             showMessage("❌ For the Femine Sakthi track, all members must be female.", "error");
//             // --- MODIFICATION START ---
//             setIsSubmitting(false);
//             // --- MODIFICATION END ---
//             return;
...
//     } finally {
//       // --- MODIFICATION START ---
//       // This 'finally' block ensures the button is re-enabled
...
//                 {/* --- MODIFICATION START --- */}
//                 {/* The button is now disabled based on the isSubmitting state */}
//                 {/* The text also changes to give the user feedback */}
